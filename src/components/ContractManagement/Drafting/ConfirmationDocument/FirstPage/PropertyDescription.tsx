...
const PropertyDescription: React.FC = () => {
  ...
  const rand = ["대", "지", "도로"];
  return (
    <div className="flex flex-col w-full items-j">
            ...
            <div className="flex">
              ...
              <div className="flex flex-col w-full">
                ...
                <div className="flex h-[84px]">
                  ...
                  <div className="w-[74px] border-br border-bb items-j">
                    지목
                  </div>
                  <div className="flex flex-col flex-1">
                    <div className="h-[42px] flex">
                      <div className="w-[150px] items-j h-full">
                        공부상 지목
                      </div>
            ...
            <div className="flex">
              ...
              <div className="flex flex-col w-full">
                ...
                <div className=" h-[126px] flex">
                  ...
                  <div className="w-[75px] border-br border-bb items-j">
                    용도
                  </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="h-[42px] flex-1 items-j">
                      <input
                        type="text"
                        className=" ml-2 w-[274px] border-32"
                      />
                    </div>
